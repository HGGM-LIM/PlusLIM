...
IF ( PLUS_USE_OPTIMET_CONOPROBE )
  SET(PLUSBUILD_ADDITIONAL_SDK_ARGS ${PLUSBUILD_ADDITIONAL_SDK_ARGS}
    ...
    -DOPTIMETSMART32SDK_64BIT_BINARY_DIR:PATH=${OPTIMETSMART32SDK_BINARY_DIR}
    -DOPTIMETSMART32SDK_64BIT_LIBRARY:PATH=${OPTIMETSMART32SDK_LIBRARY}
    )
ENDIF()

IF ( PLUS_USE_OPTITRACK )
  SET(PLUSBUILD_ADDITIONAL_SDK_ARGS ${PLUSBUILD_ADDITIONAL_SDK_ARGS}
      -DNPTrackingTools_DIR:PATH=${PLUS_NPTrackingTools_DIR}
      )
ENDIF()
